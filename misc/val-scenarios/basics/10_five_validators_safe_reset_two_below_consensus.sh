...
# 5 validators, safe reset 2 (db + wal only, priv_validator_state preserved).
...
# val4 and val5 must catch up to the current chain height via block sync, then
